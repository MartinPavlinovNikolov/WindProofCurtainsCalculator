...
class MpnDevStripe {
	...
	private function sendEmailToCustomer()
	{
		$this->mail->sendToCustomerOnOrder([
			...
			'body' => $this->replaceShortCodes($this->getMailContentForCustomerOnCustomerMakeOrder()),
			'alt_body' => strip_tags($this->replaceShortCodes($this->getMailContentForCustomerOnCustomerMakeOrder()))
		]);
